...
class NonCollisionMapTest {
    ...
    @Test
    void whenCheckPutKeyIs() {
        assertThat(map.put(1, "0000")).isFalse();
    }

    @Test
    void whenCheckPutKeyNullTwice() {
        assertThat(map.put(null, "0000")).isTrue();
        assertThat(map.put(null, "0000")).isFalse();
    }

    @Test
    void whenCheckGetBeforeExpand() {
        assertThat(map.get(1)).isEqualTo("1");
    ...
    @Test
    void checkRemoveFalse() {
        map.put(null, "0000");
        assertThat(map.remove(22)).isFalse();
        assertThat(map).hasSize(5);
    }

    @Test
    void checkRemoveTrue() {
